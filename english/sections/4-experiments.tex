...
\begin{table}[htb!]
    ...
    \begin{tblr}{width=1\textwidth, hlines, vlines,
        ...
        Model      & Post & mAP_{50}         & mAP_{50-95}       & Params (M)   & GFLOPS         \\ % Updated Header Row
        YOLOv8n    & X           & \textbf{97.1}  & \textbf{93.9}  & 3            & 8.1            \\ % Updated YOLOv8n data
        RPerceiver & X           & 93.7           & 73.0           & \textbf{0.5} & \textbf{0.6}   \\ % Updated RPerceiver data
    \end{tblr}
\end{table}
